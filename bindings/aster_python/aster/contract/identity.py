...
class ServiceContract:
    ...
    alpn: str = "aster/1"                        # field 5
    scoped: ScopeKind = ScopeKind.SHARED         # field 6: unsigned varint
    requires: CapabilityRequirement | None = None  # field 7: optional
    ...
    def from_service_info(
        ...
        """
        from aster_python.aster.service import ServiceInfo
...
def _write_service_contract(w: io.BytesIO, sc: ServiceContract) -> None:
    """Serialize a ServiceContract in canonical order (fields 1–7)."""
    ...
    write_string(w, sc.alpn)           # field 5
    write_varint(w, int(sc.scoped))   # field 6
