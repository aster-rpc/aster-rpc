...
Expected bytes: <TO BE GENERATED BY REFERENCE IMPLEMENTATION>
Expected hash:  <TO BE GENERATED BY REFERENCE IMPLEMENTATION>
```
...
**Implementation note:** Once the Rust reference implementation generates the
hex bytes and hashes for each test case, they should be committed as a JSON
fixture file (e.g. `tests/fixtures/canonical_test_vectors.json`) and used by
every language's conformance test suite.
